...
let interruptSignalSource = DispatchSource.makeSignalSource(signal: 0, queue: DispatchQueue.main)
...
let termSignalSource = DispatchSource.makeSignalSource(signal: 0, queue: DispatchQueue.main)
